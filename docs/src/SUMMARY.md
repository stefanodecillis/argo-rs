...
- [CLI Reference](cli/README.md)
    ...
    - [Pull Requests](cli/pull-requests.md)
    - [Branches](cli/branches.md)
    - [Commits](cli/commits.md)
    - [Configuration](cli/configuration.md)

- [TUI Guide](tui/README.md)
    - [Navigation & Keybindings](tui/navigation.md)

# Reference

- [Configuration](configuration/README.md)
    - [File Locations](configuration/paths.md)
    - [Credential Storage](configuration/credentials.md)
    - [AI Setup (Gemini)](configuration/ai-setup.md)
